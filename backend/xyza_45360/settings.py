"""
Django settings for xyza_45360 project.
...
WSGI_APPLICATION = 'xyza_45360.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "xyza_45360 API",
    "DESCRIPTION": "API documentation for xyza_45360 App",
    "VERSION": "v1",
}
